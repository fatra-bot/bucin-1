...
async function mulai() {
    ...
    if (nama) {
        ...
        await swals.fire({
            ...
            imageUrl: 'https://muhamadramdani.com/bucin/kosong.jpg',
            imageWidth: 200,
            imageHeight: 200,
            allowOutsideClick: false,
            focusConfirm: false
...
function WhatsApp() {
    window.location = "https://api.whatsapp.com/send?phone=6282114018869&text=Hai,%20" + "*" + nama + "*" + " udah bacain semuanya" + "%0A%0A" + "*" + nama + "*" + "%20" + window.sayang + " sama kamu " + "*" + window.persen + "*" + "%0A%0A" + dateTime;
}